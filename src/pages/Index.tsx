  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Braunschweig | Baba Friseur</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Baba Friseur in Braunschweig für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Baba Friseur | Premium Barbershop Braunschweig" />
        <meta
        ...
        <meta name="twitter:title" content="Baba Friseur | Premium Barbershop Braunschweig" />
        <meta
